...
<div id='main'>\
	...
	<div id='victim'></div>\
	<div id='submain'>\
		<div id='database' alt='Explore DB'>\
			<div id='dblist' class='explore'>\
				<div id='head'>DataBase List</div>\
				<div id='body'></div>\
			</div>\
			<div id='tblist' class='explore'>\
				<div id='head'>Table: </div>\
				<div id='body'></div>\
			</div>\
			<div id='cllist' class='explore'>\
				<div id='head'>Column: </div>\
				<div id='body' style='height: 160px;'></div>\
				<div id='foot' class='explore' style='width:99%;'></div>\
			</div>\
			<div id='datalist' class='explore' style='float: left; width: 100%;'>\
